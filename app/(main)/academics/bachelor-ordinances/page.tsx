...
export default function BachelorOrdinancesPage() {
  ...
  const [ordinanceData, setOrdinanceData] = useState<OrdinanceData>({
    heroHeading: 'Bachelor Ordinances',
    heroDescription:
      'Academic rules and regulations governing undergraduate programmes at the Institute.',
    aboutHeading: 'About Bachelor Ordinances',
    aboutContent:
      "Bachelor Ordinances define the rules, regulations, and academic framework governing undergraduate programmes at NIT Hamirpur. These ordinances outline policies related to admission, registration, curriculum structure, assessment, evaluation, progression, and award of degrees. They ensure uniformity, transparency, and academic discipline across all bachelor-level programmes. Ordinances are approved by the Institute's statutory academic bodies and apply to B.Tech., B.Arch., and Dual Degree programmes as specified.",
    howItWorksHeading: 'How Bachelor Ordinances Work',
    howItWorksPoints: [
      {
        text: 'Ordinaries are applicable from a specified academic session and are effective from the date indicated in the ordinance.',
      },
      {
        text: 'They are implemented after approval by the competent academic authorities and governing bodies.',
      },
      {
        text: 'Ordinances are updated periodically to align with national policies and academic reforms.',
      },
      {
        text: 'Students are governed by the ordinance applicable to their year of admission unless otherwise specified.',
      },
    ],
    ordinancesTableHeading: 'Bachelor Ordinances Documents',
    ordinances: [
      {
        id: 1,
        title: "Bachelor's Ordinances",
        effectiveFrom: 'w.e.f. 2024',
        viewUrl: '/documents/bachelor-ordinances-2024',
        downloadUrl: '/documents/bachelor-ordinances-2024.pdf',
      },
      {
        id: 2,
        title: "Bachelor's Ordinances",
        effectiveFrom: 'w.e.f. 2023',
        viewUrl: '/documents/bachelor-ordinances-2023',
        downloadUrl: '/documents/bachelor-ordinances-2023.pdf',
      },
      {
        id: 3,
        title: "Bachelor's Ordinances",
        effectiveFrom: 'w.e.f. 2019',
        viewUrl: '/documents/bachelor-ordinances-2019',
        downloadUrl: '/documents/bachelor-ordinances-2019.pdf',
      },
    ],
    notesHeading: 'Important Notes',
    notes: [
      'Students must follow the ordinance applicable to their admission year.',
      'Amendments, if any, will be notified separately.',
      'Ordinances are subject to revision as per Institute no',
    ],
  });
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#171717] break-words">
                Bachelor Ordinances Editor
              </h1>
              <p className="text-sm sm:text-base text-[#171717]/60 mt-1">
                Manage undergraduate programme ordinances
              </p>
            </div>
          </div>
          <button
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Bachelor Ordinances"
                  />
                </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                        placeholder="About Bachelor Ordinances"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                        placeholder="How Bachelor Ordinances Work"
                      />
                    </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                    placeholder="Bachelor Ordinances Documents"
                  />
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              placeholder="Bachelor's Ordinances"
                            />
                          </div>
                          <div>
                            <label className="block text-xs text-[#171717]/60 mb-1">
