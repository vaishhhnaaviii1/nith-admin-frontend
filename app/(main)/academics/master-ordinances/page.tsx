...
export default function MasterOrdinancesPage() {
  const [activeTab, setActiveTab] = useState<TabType>('hero');

  const [ordinanceData, setOrdinanceData] = useState<OrdinanceData>({
    heroHeading: 'Master Ordinances',
    heroDescription:
      'Academic rules and regulations governing postgraduate programmes at the Institute.',
    aboutHeading: 'About Master Ordinances',
    aboutContent:
      "Master Ordinances define the rules, regulations, and academic framework governing postgraduate programmes at NIT Hamirpur. These ordinances outline policies related to admission, registration, curriculum structure, assessment, evaluation, progression, and award of postgraduate degrees. They are approved by the Institute's statutory academic bodies and apply to M.Tech., M.Arch., M.Sc., MBA and other postgraduate programmes as specified.",
    howItWorksHeading: 'How Master Ordinances Work',
    howItWorksPoints: [
      {
    ...
    ordinancesTableHeading: 'Master Ordinances Documents',
    ordinances: [
      {
        id: 1,
        title: "Master's Ordinances",
        effectiveFrom: 'w.e.f. 2025',
        viewUrl: '/documents/master-ordinances-2025',
        downloadUrl: '/documents/master-ordinances-2025.pdf',
      },
      {
        id: 2,
        title: "Master's Ordinances",
        effectiveFrom: 'w.e.f. 2021',
        viewUrl: '/documents/master-ordinances-2021',
        downloadUrl: '/documents/master-ordinances-2021.pdf',
      },
      {
        id: 3,
        title: "Master's Ordinances",
        effectiveFrom: 'w.e.f. 2018',
        viewUrl: '/documents/master-ordinances-2018',
        downloadUrl: '/documents/master-ordinances-2018.pdf',
      },
    ],
    ...
    notes: [
      ...
      'Ordinances are subject to revision as per Institute norms.',
    ],
  });
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#171717] break-words">
                Master Ordinances Editor
              </h1>
              <p className="text-sm sm:text-base text-[#171717]/60 mt-1">
                Manage postgraduate programme ordinances
              </p>
            </div>
          </div>
          <button
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                        placeholder="About Master Ordinances"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                        placeholder="How Master Ordinances Work"
                      />
                    </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm sm:text-base"
                    placeholder="Master Ordinances Documents"
                  />
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              placeholder="Master's Ordinances"
                            />
                          </div>
                          <div>
                            <label className="block text-xs text-[#171717]/60 mb-1">
