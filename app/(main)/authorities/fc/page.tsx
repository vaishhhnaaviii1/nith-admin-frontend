...
export default function FCPage() {
    ...
    members: [
      {
        ...
        position: 'Director',
        email: 'chairman.fc@nith.ac.in',
        contactPhone: '+91-1972-254001',
      },
      {
        id: '2',
        name: 'Prof. Finance Officer',
        designation: 'Member Secretary',
        affiliation: 'NIT Hamirpur',
        position: 'Chief Finance Officer',
        email: 'cfo@nith.ac.in',
        contactPhone: '+91-1972-254003',
      },
    ],
    minutes: [
      {
        id: '1',
        title: 'FC Meeting March 2024',
        date: '2024-03-20',
        documentUrl: '/documents/fc/minutes-march-2024.pdf',
  ...
  const updateMember = (
    ...
    const updated = [...fcData.members];
    updated[index] = { ...updated[index], [field]: value };
    setFcData({ ...fcData, members: updated });
  };
  ...
  const removeMember = (index: number) => {
    setFcData({
      ...fcData,
      members: fcData.members.filter((_, i) => i !== index),
    });
  };
  ...
  const updateMinute = (
    ...
    const updated = [...fcData.minutes];
    updated[index] = { ...updated[index], [field]: value };
    setFcData({ ...fcData, minutes: updated });
  };
  ...
  const removeMinute = (index: number) => {
    setFcData({
      ...fcData,
      minutes: fcData.minutes.filter((_, i) => i !== index),
    });
  };
    ...
    <div className="space-y-4 sm:space-y-6 p-2 sm:p-4 lg:p-6">
      <div className="bg-gradient-to-r from-[#631012] to-[#7a1214] rounded-lg shadow-lg p-4 sm:p-6 lg:p-8 text-white">
        ...
        <p className="text-sm sm:text-base text-white/90">
          Manage FC members and meeting minutes
        </p>
      </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm sm:text-base text-[#171717]/60 mt-1">
                Edit Finance Committee content
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 sm:p-6">
          ...
          {activeTab === 'members' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                {fcData.members.map((member, index) => (
                  <div
                    key={member.id}
          ...
          {activeTab === 'minutes' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                {fcData.minutes.map((minute, index) => (
                  <div
                    key={minute.id}
                    className="p-4 border border-[#171717]/20 rounded-lg bg-[#F9F9F9] space-y-3"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm"
                          placeholder="/documents/fc/minutes.pdf"
                        />
                      </div>
                      <div>
                        <label className="block text-xs text-[#171717]/60 mb-1">
