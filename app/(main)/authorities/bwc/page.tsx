...
export default function BWCPage() {
  ...
  const [bwcData, setBwcData] = useState<BWCData>({
    members: [
      {
        id: '1',
        name: 'Prof. Committee Head',
        designation: 'Chairman',
        affiliation: 'NIT Hamirpur',
        position: 'Director',
        email: 'chairman.bwc@nith.ac.in',
        contactPhone: '+91-1972-254001',
      },
      {
        id: '2',
        name: 'Shri Works Engineer',
        designation: 'Member Secretary',
        affiliation: 'NIT Hamirpur',
        position: 'Chief Engineer',
        email: 'ce@nith.ac.in',
        contactPhone: '+91-1972-254004',
      },
    ],
    minutes: [
      {
        id: '1',
        title: 'BWC Meeting April 2024',
        date: '2024-04-10',
        documentUrl: '/documents/bwc/minutes-april-2024.pdf',
        uploadedDate: '2024-04-15',
        uploadedBy: 'Works Admin',
      },
    ],
  });
  ...
  const updateMember = (
    ...
    const updated = [...bwcData.members];
    updated[index] = { ...updated[index], [field]: value };
    setBwcData({ ...bwcData, members: updated });
  };
  ...
  const removeMember = (index: number) => {
    setBwcData({
      ...bwcData,
      members: bwcData.members.filter((_, i) => i !== index),
    });
  };
  ...
  const updateMinute = (
    ...
    const updated = [...bwcData.minutes];
    updated[index] = { ...updated[index], [field]: value };
    setBwcData({ ...bwcData, minutes: updated });
  };
  ...
  const removeMinute = (index: number) => {
    setBwcData({
      ...bwcData,
      minutes: bwcData.minutes.filter((_, i) => i !== index),
    });
  };
    ...
    <div className="space-y-4 sm:space-y-6 p-2 sm:p-4 lg:p-6">
      <div className="bg-gradient-to-r from-[#631012] to-[#7a1214] rounded-lg shadow-lg p-4 sm:p-6 lg:p-8 text-white">
        ...
        <p className="text-sm sm:text-base text-white/90">
          Manage BWC members and meeting minutes
        </p>
      </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm sm:text-base text-[#171717]/60 mt-1">
                Edit Building & Works Committee content
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 sm:p-6">
          ...
          {activeTab === 'members' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                {bwcData.members.map((member, index) => (
                  <div
                    key={member.id}
          ...
          {activeTab === 'minutes' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                {bwcData.minutes.map((minute, index) => (
                  <div
                    key={minute.id}
                    className="p-4 border border-[#171717]/20 rounded-lg bg-[#F9F9F9] space-y-3"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-[#171717]/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#631012] focus:border-transparent text-black text-sm"
                          placeholder="/documents/bwc/minutes.pdf"
                        />
                      </div>
                      <div>
                        <label className="block text-xs text-[#171717]/60 mb-1">
